# To create sample data in your moms_db database, you can use Django's management commands. Here's a Python script that creates sample data for the key modules:
...
#To run this script:
#Save it as sample_data.py in your backend directory
#Run it with:

cd C:\Users\zilih\OneDrive\Documents\TEC-BridgeAI\MOMS\backend
python sample_data.py

# This script creates:
# Admin user (admin/admin123) and 5 regular users
# HR departments and employees
# CRM customers, contacts, and opportunities
# Projects and tasks
# Finance accounts
# Suppliers and products

# You can then log in with the admin user to see and manage this data.
